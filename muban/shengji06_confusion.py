...
def main():
    ...
    all_acc = []
    # for aggregating confusion matrices across subjects
    ...
    for de_fname in de_files:
        ...
        # torch.save(model.state_dict(), os.path.join(save_dir, f"{subj_id}.pth"))
    ...
    im = ax.imshow(agg_cm, interpolation='nearest', cmap='Blues')
