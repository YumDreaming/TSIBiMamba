...
class CoBlock(nn.Module):
    ...
    def forward(self, g, r):
        ...
        g = g + self.drop_path(self.gamma_2 * self.mlp(self.norm2(g)))
        r = r + self.drop_path(self.gamma_2 * self.mlp(self.norm2(r)))
        return g, r
...
class CoMambaVisionLayer(nn.Module):
    ...
    def forward(self, g, r):
        ...
        g = window_reverse(g, self.window_size, Hp, Wp)
